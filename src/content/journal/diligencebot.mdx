...
> I'll be updating this periodically as well - you can always check out the history on [GitHub](https://github.com/awantoch/portfolio/commits/main/src/content/journal/diligencebot.mdx) if you're curious!
